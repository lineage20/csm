...
RECOVERY="php -d error_log=/www/hx9999.com/inf.hx9999.com/log/php_errors.log -c /srv/php/etc/php-cli.ini /www/hx9999.com/inf.hx9999.com/daemon/synchronous.hxpm.php restart"
